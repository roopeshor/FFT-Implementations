...
set sweep_list {128 256 512 1024 2048 4096 8192}
# CHANGE THIS to your actual FPGA part number
set target_part "xc7a100tcsg324-1" ;
set top_module "fft_radix2"
# 2. Start the sweep loop
foreach val $sweep_list {
    puts "======================================================="
    puts " STARTING RUN: N = $val"
    puts "======================================================="
    ...
    synth_design -top $top_module -part $target_part -generic N=$val
    ...
    set report_file "reports/master_report_N_${val}.txt"

    # Step A: Open the file in write mode ("w") for raw Tcl outputs
    set fp [open $report_file "w"]
    
    puts $fp "======================================================="
    puts $fp " MASTER REPORT: R2_inplace FFT (N = $val)"
    puts $fp "======================================================="
    ...
    write_checkpoint -force "chkp/R2_inplace_implemented_N_${val}.dcp"

    puts "======================================================="
    puts " FINISHED RUN: N = $val"
    puts "======================================================="
}
